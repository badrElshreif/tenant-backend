...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('tenant')->create('store_temps', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('city_id')->nullable()->index('store_temps_city_id_foreign');
            ...
            $table->unsignedBigInteger('store_id')->index('store_temps_store_id_foreign');
    ...
    {
        Schema::connection('tenant')->dropIfExists('store_temps');
    }
};
